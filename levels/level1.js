...
function initLevel() {
    level1 = new Level(
        ...
        [
        new Tile("img/tiles_ground/ground_tile08.png", 300, 250, 50, 50),
        new Tile("img/tiles_ground/ground_tile10.png", 350, 250, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 400, 250, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 450, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 500, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 600, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 650, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 1100, 250, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 1150, 250, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 1200, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile10.png", 1250, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 1300, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 1400, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile10.png", 1450, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile10.png", 1500, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 1550, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 2300, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 2350, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 2400, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 2450, 200, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 2500, 150, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 2550, 150, 50, 50),
        new Tile("img/tiles_ground/ground_tile08.png", 2600, 100, 50, 50),
        new Tile("img/tiles_ground/ground_tile09.png", 2650, 100, 50, 50),
        
        new Tile("img/tiles_ground/ground_tile01.png", 3425, 403, 50, 50),
        new Tile("img/tiles_ground/ground_tile23.png", 3475, 403, 50, 50),
        new Tile("img/tiles_ground/ground_tile06.png", 3525, 403, 50, 50),
        new Tile("img/tiles_ground/ground_tile06.png", 3575, 403, 50, 50),
        new Tile("img/tiles_ground/ground_tile06.png", 3625, 403, 50, 50),
        new Tile("img/tiles_ground/ground_tile06.png", 3675, 403, 50, 50),
        new Tile("img/tiles_ground/ground_tile06.png", 3725, 403, 50, 50),
        new Tile("img/tiles_ground/ground_tile06.png", 3775, 403, 50, 50),
        new Tile("img/tiles_ground/ground_tile01.png", 3475, 353, 50, 50),
        new Tile("img/tiles_ground/ground_tile07.png", 3525, 353, 50, 50),
        new Tile("img/tiles_ground/ground_tile07.png", 3575, 353, 50, 50),
        new Tile("img/tiles_ground/ground_tile07.png", 3625, 353, 50, 50),
        new Tile("img/tiles_ground/ground_tile07.png", 3675, 353, 50, 50),
        new Tile("img/tiles_ground/ground_tile07.png", 3725, 353, 50, 50),
        new Tile("img/tiles_ground/ground_tile07.png", 3775, 353, 50, 50),
    ...
    function createGroundTiles() {
        ...
        for (let i = -5; i < numTiles + 20; i++) {
            tiles.push(new Tile("img/tiles_ground/ground_tile07.png", Math.round(i * tileWidth), y_top, tileWidth, tileHeight));
            tiles.push(new Tile("img/tiles_ground/ground_tile06.png", Math.round(i * tileWidth), y_bottom, tileWidth, tileHeight));
        }
        return tiles;
    }
}
