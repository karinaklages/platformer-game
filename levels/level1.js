const level1 = new Level(
    ...
    new GroundTile("../img/tiles_ground/ground_tile08.png", 1100, 350, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile09.png", 1150, 350, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile08.png", 1200, 400, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile10.png", 1250, 400, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile09.png", 1300, 400, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile08.png", 1400, 400, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile09.png", 1450, 400, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile08.png", 1550, 300, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile09.png", 1600, 300, 50, 50),

    new GroundTile("../img/tiles_ground/ground_tile08.png", 2300, 400, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile09.png", 2350, 400, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile08.png", 2400, 350, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile09.png", 2450, 350, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile08.png", 2500, 300, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile09.png", 2550, 300, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile08.png", 2600, 250, 50, 50),
    new GroundTile("../img/tiles_ground/ground_tile09.png", 2650, 250, 50, 50)
    ],
    [
